    ...
    <main className="relative min-h-screen overflow-hidden bg-[#07111c]">
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-10">
        ...
        <section className="mx-auto max-w-lg py-16 sm:py-24">
          <div className="rounded-3xl border border-white/10 bg-[#101e2d]/95 p-7 shadow-[0_24px_80px_rgba(0,0,0,0.35)] sm:p-10">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-cyan-300">Invitation accepted</p>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-white">Set your FaultTrace password</h1>
            <p className="mt-3 text-sm leading-7 text-slate-400">Choose a password for {data.user.email}. You will continue to the workspace assigned by your administrator.</p>
            <SetPasswordForm />
          </div>
        </section>
      </div>
